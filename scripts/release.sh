...
echo "curl -L -o /tmp/Jellyfin.Plugin.Share.dll https://github.com/monxas/jellyfin-share-plugin/releases/download/v$VERSION/Jellyfin.Plugin.Share.dll && docker cp /tmp/Jellyfin.Plugin.Share.dll 'jellyfin:/config/data/plugins/Jellyfin Share_$VERSION.0/Jellyfin.Plugin.Share.dll' && docker restart jellyfin"
